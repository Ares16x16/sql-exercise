...
$query = "SELECT member_ID, name FROM member WHERE member_ID IN (SELECT member_ID FROM enrollment WHERE class_ID IN (SELECT class_ID FROM class WHERE name LIKE '%Water Aerobics%')) ORDER BY member_ID DESC ";
