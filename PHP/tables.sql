...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=34532061ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=3278a2&table=enrollment">`3278a2`.`enrollment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=3278a2&table=member">`3278a2`.`member`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=3278a2&table=class">`3278a2`.`class`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=3278a2&table=branch">`3278a2`.`branch`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=3278a2&table=instructor">`3278a2`.`instructor`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=3278a2&table=Branch">`3278a2`.`Branch`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="503747282e347b4e6c7466492a5d4a64">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="3278a2" targettable="branch">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `branch`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="3278a2" targettable="enrollment">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `enrollment`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="3278a2" targettable="class">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `class`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="3278a2" targettable="instructor">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `instructor`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="3278a2" targettable="branch">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `class`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="3278a2" targettable="member">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
